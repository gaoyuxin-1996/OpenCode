...
public class Constant {
	...
	// "/src/resource/cert/outgoing.CertwithKey.pkcs12";
	// public static String TRUSTCAPATH = "/src/resource/cert/ca.jks";
	// new
	// public static String SELFCERTPATH =
	// "/opt/apache-tomcat-8.0.50/webapps/Test/WEB-INF/classes/resource/cert/outgoing.CertwithKey.pkcs12";
	// public static String TRUSTCAPATH =
	// "/opt/apache-tomcat-8.0.50/webapps/Test/WEB-INF/classes/resource/cert/ca.jks";
	// 每個應用需要修改的地方

	public static String SELFCERTPATH = "/opt/apache-tomcat-8.0.50/webapps/GPSWeb/WEB-INF/classes/resource/cert/outgoing.CertwithKey.pkcs12";
	public static String TRUSTCAPATH = "/opt/apache-tomcat-8.0.50/webapps/GPSWeb/WEB-INF/classes/resource/cert/ca.jks";
