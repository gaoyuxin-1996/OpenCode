...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "当前1 to 10 of 57 entries") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default 当前_START_ to _END_ of _TOTAL_ entries
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "当前page _PAGE_ of _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "当前_START_ ~ _END_ 总计 _TOTAL_ 条",
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Table information element (the '当前x of y records' div) enable
			 * flag.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
