...
public class UserDao extends Dao {
	...
	public int insert(User user) {
		...
		try {
			...
			res = sql.execute("insert into user values('" + user.getName() + "','" + user.getPassword() + "','"
	...
	public int update(User user) {
		...
		try {
			...
			res = sql.execute("update user set name = '" + user.getName() + "'," + "phone ='" + user.getPhone() + "',"
					+ "password = '" + user.getPassword() + "'," + "email = '" + user.getEmail() + "'," + "gongsi = '"
					+ user.getGongsi() + "'," + "bumen = '" + user.getBumen() + "'," + "quanxian = '"
					+ user.getQuanxian() + "'," + "xingming = '" + user.getXingming() + "'," + "address = '"
					+ user.getAddress() + "'" + " where name = '" + user.getName() + "'");
